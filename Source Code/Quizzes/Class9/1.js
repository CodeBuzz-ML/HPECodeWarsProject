var questions = [
    ...
    {
        question: "Which of the following is the solution to the inequality 2x + 5 < 15?",
        answer: "x < 5",
        options: [
            "x > 5",
            "x = 5",
    ...
    {
        question: "What is the slope of the line passing through the points (3, 5) and (7, 11)?",
        answer: "1",
        options: [
            "1",
            "2",
